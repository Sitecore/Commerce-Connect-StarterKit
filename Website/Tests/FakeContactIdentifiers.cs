// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FakeContactIdentifiers.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Defines the FakeContactIdentifiers class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.StarterKit.Tests
{
    ...
    public class FakeContactIdentifiers : IContactIdentifiers
    {
        public Analytics.Model.AuthenticationLevel AuthenticationLevel { get; set; }
        public Analytics.Model.ContactIdentificationLevel IdentificationLevel { get; set; }
