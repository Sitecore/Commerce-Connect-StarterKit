...
namespace Sitecore.Commerce.StarterKit.Controllers
{
  ...
  public class ProductController : Controller
  {
    ...
    public ProductController([NotNull] IProductService productService, [NotNull] IPricingService pricingService, ContentSearchHelper contentSearchHelper, [NotNull] IInventoryService inventoryService)
    {
