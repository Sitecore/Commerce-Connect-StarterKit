...
namespace Sitecore.Commerce.StarterKit.Services
{
  ...
  public class CartService : ICartService
  {
    ...
    /// <param name="wishListServiceProvider"></param>
    ...
    {
      var result = _customerServiceProvider.AddParties(new Commerce.Services.Customers.AddPartiesRequest(
    ...
    {
      var result = _customerServiceProvider.GetParties(new GetPartiesRequest(new CommerceCustomer() { ExternalId = this.GetCart().ExternalId }));
      if (result == null)
      {
        return Enumerable.Empty<Party>();
      }
    ...
    {
      var result = _customerServiceProvider.UpdateParties(new Sitecore.Commerce.Services.Customers.UpdatePartiesRequest(new CommerceCustomer() { ExternalId = this.GetCart().ExternalId }, parties));
    ...
    {
      var result = _wishListServiceProvider.GetWishList(new GetWishListRequest(userName, userName, this.shopName));
    ...
    {
      var result = _wishListServiceProvider.CreateWishList(new CreateWishListRequest(this.VisitorId, this.VisitorId, this.shopName));
    ...
    public WishList AddToWishList(string productId, uint quantity)
    {
      ...
      var result =
          _wishListServiceProvider.AddLinesToWishList(new AddLinesToWishListRequest(wishList, new List<WishListLine>() { new WishListLine() { Product = new CartProduct() { ProductId = productId }, Quantity = quantity } }));
    ...
    {
      var result = _wishListServiceProvider.RemoveWishListLines(
