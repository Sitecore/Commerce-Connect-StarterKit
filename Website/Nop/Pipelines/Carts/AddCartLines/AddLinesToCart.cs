...
// ---------------------------------------------------------------------
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Carts.AddCartLines
{
  ...
  /// <summary>
  /// Processor that adds specified cart lines to cart in instance of NopCommerce e-commerce system via the WCF service.
  /// </summary>
  public class AddLinesToCart : ChangeLinesProcessor
  {
    /// <summary>
    /// Changes the lines.
    /// </summary>
    ...
    protected override ShoppingCartModel ChangeLines(ShoppingCartModel cartModel, ICartsServiceChannel client, CartLine cartLine)
    {
      ...
      {
        cartModel = client.AddProduct(cartModel.CustomerGuid, cartLine.Product.ProductId, cartLine.Quantity);
      }
