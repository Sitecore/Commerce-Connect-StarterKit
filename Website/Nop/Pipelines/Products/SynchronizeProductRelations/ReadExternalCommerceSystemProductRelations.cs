// ---------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemProductRelations.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Reads external commerce system product relations.
// </summary>
// ---------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Products.SynchronizeProductRelations
{
  ...
  /// Reads external commerce system product relations.
  /// </summary>
  public class ReadExternalCommerceSystemProductRelations : ReadExternalCommerceSystemProductRelationsBase
  {
    /// <summary>
    ...
    {
      return client.GetRelatedProductsIds(externalProductId);
    }
  }
}