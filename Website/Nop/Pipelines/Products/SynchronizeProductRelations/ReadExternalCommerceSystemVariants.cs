// ---------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemVariants.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Reads external commerce system variants.
// </summary>
// ---------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Products.SynchronizeProductRelations
{
  ...
  /// Reads external commerce system variants.
  /// </summary>
  public class ReadExternalCommerceSystemVariants : ReadExternalCommerceSystemProductRelationsBase
  {
    /// <summary>
