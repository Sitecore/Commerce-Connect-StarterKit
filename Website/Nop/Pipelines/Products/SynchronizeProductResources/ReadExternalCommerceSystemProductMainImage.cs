// ---------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemProductMainImage.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   The read external commerce system product main image.
// </summary>
// ---------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Products.SynchronizeProductResources
{
  ...
  /// The read external commerce system product main image.
  /// </summary>
  public class ReadExternalCommerceSystemProductMainImage : ReadExternalCommerceSystemProductResourceBase
  {
    /// <summary>
    /// Gets the resource.
    /// </summary>
    ...
    {
      return nopServiceClient.GetProductMainImage(externalProductId);
    }
  }
}