// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemProductDownloads.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   The read external commerce system product downloads.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Products.SynchronizeProductResources
{
  ...
  /// The read external commerce system product downloads.
  /// </summary>
  public class ReadExternalCommerceSystemProductDownloads : ReadExternalCommerceSystemProductResourceBase
  {
    /// <summary>
    /// Gets the resource.
    /// </summary>
