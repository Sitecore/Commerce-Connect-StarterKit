// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AddCustomerPaymentInfo.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>Defines the AddCustomerPaymentInfo class.</summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Customers
{
    ...
    /// </summary>
    public class AddCustomerPaymentInfo : NopProcessor<ICustomersServiceChannel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddCustomerPaymentInfo"/> class.
        /// </summary>
        /// <param name="entityFactory">The entity factory.</param>
        public AddCustomerPaymentInfo(IEntityFactory entityFactory)
        {
        ...
        public override void Process(ServicePipelineArgs args)
        {
            ...
            var request = (AddCustomerPaymentInfoRequest)args.Request;
            ...
            using (ICustomersServiceChannel channel = this.GetClient())
            {
                ...
                existingPayments.AddRange(request.Payments);
                ...
                try
                {
                    ...
                    {
                        result.Success = false;
                        result.SystemMessages.Add(new SystemMessage { Message = "Error occuder while adding payment information to Cusomer " + request.CommerceCustomer.ExternalId });
                    }
                }
                catch (Exception)
                {
                    result.Success = false;
                    result.SystemMessages.Add(new SystemMessage { Message = "Communication error, while adding payment information to Cusomer " + request.CommerceCustomer.ExternalId });
                }
            }
        }
    }
