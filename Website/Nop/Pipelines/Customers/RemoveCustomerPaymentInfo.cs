// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RemoveCustomerPaymentInfo.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>Defines the RemoveCustomerPaymentInfo class.</summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Customers
{
    ...
    /// </summary>
    public class RemoveCustomerPaymentInfo : NopProcessor<ICustomersServiceChannel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveCustomerPaymentInfo"/> class.
        /// </summary>
        /// <param name="entityFactory">The entity factory.</param>
        public RemoveCustomerPaymentInfo(IEntityFactory entityFactory)
        {
        ...
        public override void Process(ServicePipelineArgs args)
        {
            ...
            var request = (RemoveCustomerPaymentInfoRequest)args.Request;
            ...
            using (ICustomersServiceChannel channel = this.GetClient())
            {
                ...
                existingPayments.RemoveAll(ep => request.Payments.Any(p => string.Equals(ep.ExternalId, p.ExternalId, StringComparison.OrdinalIgnoreCase)));
                ...
                try
                {
                    ...
                    {
                        result.Success = false;
                        result.SystemMessages.Add(new SystemMessage { Message = "Error occuder while removing payment information to Cusomer " + request.CommerceCustomer.ExternalId });
                    }
                }
                catch (Exception)
                {
                    result.Success = false;
                    result.SystemMessages.Add(new SystemMessage { Message = "Communication error, while removing payment in formation from Cusomer " + request.CommerceCustomer.ExternalId });
                }
            }
        }
    }
