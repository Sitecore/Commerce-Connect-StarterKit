// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetBackOrderableInformation.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Defines the pipeline processor that gets back-orderable stock information.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Pipelines.Inventory.GetOrderableInformation
{
    ...
    /// </summary>
    public class GetBackOrderableInformation : NopProcessor<IInventoryServiceChannel>
    {   
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBackOrderableInformation"/> class.
        /// </summary>
        /// <param name="entityFactory">The entity factory.</param>
        public GetBackOrderableInformation([NotNull] IEntityFactory entityFactory)
        {
        ...
        {
            var request = (GetBackOrderableInformationRequest)args.Request;
            var result = (GetBackOrderableInformationResult)args.Result;
            ...
            using (IInventoryServiceChannel client = this.GetClient())
            {
                ...
                orderableInformationModels = client.GetBackOrderableInformationList(request.Shop.Name, request.Products.Select(p => p.ProductId).ToArray(), visitorId);
            }
