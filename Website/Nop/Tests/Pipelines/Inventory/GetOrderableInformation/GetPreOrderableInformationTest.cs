// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetPreOrderableInformationTest.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Defines the GetPreOrderableInformationTest class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Tests.Pipelines.Inventory.GetOrderableInformation
{
    ...
    /// Defines the GetPreOrderableInformationTest class.
    /// </summary>
    public class GetPreOrderableInformationTest
    {
        /// <summary>
        /// The client.
        /// </summary>
        ...
        /// <summary>
        /// The get product pre-orderable information.
        /// </summary>
        private readonly GetPreOrderableInformation _processor;

        /// <summary>
        /// Initializes a new instance of the <see cref="GetPreOrderableInformationTest" /> class.
        /// </summary>
        public GetPreOrderableInformationTest()
        {
            ...
            this._processor = new GetPreOrderableInformation(entityFactory) { ClientFactory = clientFactory };
        }

        /// <summary>
        /// Should get product pre-orderable information for the specified products.
        /// </summary>
        [Fact]
        public void ShouldGetPreOrderableInformationForTheSpecifiedProducts()
        {
            // Arrange
            var request = new GetPreOrderableInformationRequest("shopname", new List<InventoryProduct> { new InventoryProduct { ProductId = "pid1" }});
        ...
        /// <summary>
        /// Should not add new records if product pre-orderable information is not found.
        /// </summary>
        [Fact]
        public void ShouldNotAddNewRecordsIfProductPreOrderableInformationIsNotFound()
        {
            // Arrange
            var request = new GetPreOrderableInformationRequest("shopname", new List<InventoryProduct> { new InventoryProduct { ProductId = "noExist" } });
            var result = new GetPreOrderableInformationResult();
            var args = new ServicePipelineArgs(request, result);
