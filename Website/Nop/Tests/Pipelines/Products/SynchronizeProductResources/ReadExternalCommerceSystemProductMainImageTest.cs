// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemProductMainImageTest.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   The read external commerce system product main image test.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Tests.Pipelines.Products.SynchronizeProductResources
{
  ...
  /// The read external commerce system product main image test.
  /// </summary>
  public class ReadExternalCommerceSystemProductMainImageTest
  {
    /// <summary>
    /// The entity factory.
    /// </summary>
    ...
    /// The processor.
    /// </summary>
    private readonly ReadExternalCommerceSystemProductMainImage processor;
    ...
    public ReadExternalCommerceSystemProductMainImageTest()
    {
      ...
      this.processor = new ReadExternalCommerceSystemProductMainImage { EntityFactory = this.entityFactory, ClientFactory = clientFactory };
    ...
    public void ShouldGetProductAlternateImages()
    {
      ...
      // assert
      this.client.Received().GetProductMainImage("100500");
    }
