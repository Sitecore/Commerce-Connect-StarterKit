// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemVariantsTest.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   The read external commerce system variants test.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Tests.Pipelines.Products.SynchronizeProductRelations
{
  ...
  /// The read external commerce system variants test.
  /// </summary>
  public class ReadExternalCommerceSystemVariantsTest
  {
    /// <summary>
    /// The entity factory.
    /// </summary>
    ...
    /// The processor.
    /// </summary>
    private readonly ReadExternalCommerceSystemVariants processor;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReadExternalCommerceSystemVariantsTest"/> class.
    /// </summary>
    public ReadExternalCommerceSystemVariantsTest()
    {
      ...
      this.processor = new ReadExternalCommerceSystemVariants { EntityFactory = this.entityFactory, ClientFactory = clientFactory };
    ...
    {
      // arrange
      this.client.GetVariantProductsIds("100500").Returns(new[] { "1", "5" });
      ...
      relationType.Name.Should().Be("Variants");
