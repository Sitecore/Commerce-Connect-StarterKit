// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReadExternalCommerceSystemCrossSalesTest.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Defines the ReadExternalCommerceSystemCrossSales type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Connectors.NopCommerce.Tests.Pipelines.Products.SynchronizeProductRelations
{
  ...
  /// <summary>
  /// The read external commerce system cross sales test.
  /// </summary>
  public class ReadExternalCommerceSystemCrossSalesTest
  {
    /// <summary>
    /// The entity factory.
    /// </summary>
    ...
    /// The processor.
    /// </summary>
    private readonly ReadExternalCommerceSystemCrossSales processor;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReadExternalCommerceSystemCrossSalesTest"/> class.
    /// </summary>
    public ReadExternalCommerceSystemCrossSalesTest()
    {
      ...
      this.processor = new ReadExternalCommerceSystemCrossSales { EntityFactory = this.entityFactory, ClientFactory = clientFactory };
    ...
    public void ShouldPreformReadOperation()
    {
      ...
      relationType.Name.Should().Be("Cross-sells");

      relationType.Relations.Should().Contain(r => r.ExternalId == "4" || r.ExternalId == "1");
    }
