...
namespace Sitecore.Commerce.Nop.Payments.SamplePaymentService
{
    ...
    using Sitecore.Commerce.Nop.Payments.SamplePaymentService.Controllers;
    ...
    public class SamplePaymentServicePaymentProcessor : BasePlugin, IPaymentMethod, IPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            dictionary.Add("Namespaces", "Sitecore.Commerce.Nop.Payments.SamplePaymentService.Controllers");
