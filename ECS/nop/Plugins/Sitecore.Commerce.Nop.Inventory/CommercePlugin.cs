...
// </copyright>
// <summary>
//   Defines the CommercePlugin type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Commerce.Nop.Inventory
{
    ...
    public class CommercePlugin : BasePlugin, IMiscPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "SitecoreCommerceInventory";
            routeValues = new RouteValueDictionary { { "Namespaces", "Sitecore.Commerce.Nop.Inventory.Controllers" }, { "area", null } };
        }
    }
}
