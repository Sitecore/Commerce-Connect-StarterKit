...
// -----------------------------------------------------------------
namespace Sitecore.Commerce.Nop.Inventory
{
    using System;
    ...
    using Sitecore.Commerce.Nop.Inventory.Models;
    ...
    public class InventoryService : IInventoryService
    {
        ...
        /// <param name="externalproductIds">The externalproduct ids.</param>
        /// <param name="customerId">The customer identifier.</param>
        /// <returns>The product pre orderable information.</returns>
        [WebMethod(EnableSession = false)]
        ...
        [WebMethod(EnableSession = false)]
        public virtual IList<OrderableInformationModel> GetBackOrderableInformationList(string shopName, IList<string> externalproductIds, Guid customerId)
        {
        ...
        /// <param name="shopName">Name of the shop.</param>
        /// <returns>True if the product is available in the specified shop, otherwise false.</returns>
