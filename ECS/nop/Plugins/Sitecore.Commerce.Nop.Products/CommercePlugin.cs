...
// -----------------------------------------------------------------
namespace Sitecore.Commerce.Nop.Products
{
    ...
    using CommerceProductService;

    /// <summary>
    /// Entry point for Commerce plugin.
    /// </summary>
    public class CommercePlugin : BasePlugin, IMiscPlugin, IConsumer<EntityUpdated<Product>>,
                                                                ...
                                                                IConsumer<EntityUpdated<ProductVariantAttribute>>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommercePlugin" /> class.
        /// </summary>
        /// <param name="permissionService">The permission service.</param>
        public CommercePlugin(IPermissionService permissionService)
        {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "SitecoreCommerceProducts";
            routeValues = new RouteValueDictionary { { "Namespaces", "Sitecore.Commerce.Nop.Products.Controllers" }, { "area", null } };
        }
        ...
        public override void Install()
        {
            ...
            _permissionService.InstallPermissions(new CommerceProductsPermissionProvider());

            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description1", "Actually configuration is not required. Just some notes:");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description2", "Ensure that permissions are properly configured on Access Control List page (disabled by default)");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description3", "To access service use {0}");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description4", "For mex endpoint use {0}");
            base.Install();
        }
        ...
        public override void Uninstall()
        {
            ...
            _permissionService.UninstallPermissions(new CommerceProductsPermissionProvider());

            //locales
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description1");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description2");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description3");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Nop.Products.Description4");
