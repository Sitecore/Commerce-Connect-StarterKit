...
namespace Nop.Plugin.Sitecore.Commerce.Products
{
                                                                ...
                                                                IConsumer<EntityUpdated<ProductVariantAttribute>>
    {
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description1", "Actually configuration is not required. Just some notes:");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description2", "Ensure that permissions are properly configured on Access Control List page (disabled by default)");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description3", "To access service use {0}");
            this.AddOrUpdatePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description4", "For mex endpoint use {0}");
            base.Install();
        }
        ...
        public override void Uninstall()
        {
            ...
            //locales
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description1");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description2");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description3");
            this.DeletePluginLocaleResource("Plugins.Sitecore.Commerce.Products.Description4");
