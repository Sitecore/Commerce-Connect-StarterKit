...
// -----------------------------------------------------------------
namespace Sitecore.Commerce.Nop.Carts.Products.Tests
{
  using System;
  ...
  using global::Nop.Core.Domain.Media;
  using global::Nop.Core.Domain.Stores;
  using global::Nop.Core.Infrastructure;
  using Sitecore.Commerce.Nop.Products;
  using Sitecore.Commerce.Nop.Products.Models;
