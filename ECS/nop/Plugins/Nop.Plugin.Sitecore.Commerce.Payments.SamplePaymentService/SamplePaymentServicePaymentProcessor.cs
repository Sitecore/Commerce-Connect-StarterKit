...
namespace Nop.Plugin.Sitecore.Commerce.Payments.SamplePaymentService
{
    ...
    using Nop.Plugin.Sitecore.Commerce.Payments.SamplePaymentService.Controllers;
    ...
    public class SamplePaymentServicePaymentProcessor : BasePlugin, IPaymentMethod, IPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            dictionary.Add("Namespaces", "Nop.Plugin.Sitecore.Commerce.Payments.SamplePaymentService.Controllers");
