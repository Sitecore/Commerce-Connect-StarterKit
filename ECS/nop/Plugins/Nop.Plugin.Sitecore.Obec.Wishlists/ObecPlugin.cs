...
namespace Nop.Plugin.Sitecore.Commerce.Wishlists
{
  ...
  public class ObecPlugin : BasePlugin, IMiscPlugin
  {
    ...
    public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
    {
      ...
      controllerName = "SitecoreObecWishlists";
      routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Sitecore.Commerce.Wishlists.Controllers" }, { "area", null } };
    }
  }
}