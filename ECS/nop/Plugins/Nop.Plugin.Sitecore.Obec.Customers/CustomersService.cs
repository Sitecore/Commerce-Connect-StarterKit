...
namespace Nop.Plugin.Sitecore.Commerce.Customers
{
  ...
  public class CustomersService : ICustomersService
  {
    ...
    /// </summary>
    private readonly Services.Customers.ICustomerService customerService;
    ...
    {
      this.customerService = EngineContext.Current.Resolve<Services.Customers.ICustomerService>();
    ...
    {
      if (customerModel == null) throw new ArgumentNullException("customerModel");
    ...
    {
      if (customerModel == null)  throw new ArgumentNullException("customerModel");
      if (existingCustomer == null) throw new ArgumentNullException("existingCustomer");
