// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommerceWishlistsPermissionProvider.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>
//   Class for CommerceWishlistsPermissionProvider
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
// -----------------------------------------------------------------
namespace Sitecore.Commerce.Nop.Wishlists.Security
{
    ...
    /// </summary>
    public class CommerceWishlistsPermissionProvider : IPermissionProvider
    {
        /// <summary>
        ...
        public static readonly PermissionRecord AccessWebService = new PermissionRecord
        {
            ...
            SystemName = "AccessSitecoreCommerceProductsService",
            Category = "Plugin"
        };
